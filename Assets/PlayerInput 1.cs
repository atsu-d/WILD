...
public partial class @PlayerInput1 : IInputActionCollection2, IDisposable
{
    ...
    {
        private @PlayerInput1 m_Wrapper;
        public CameraActions(@PlayerInput1 wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @PlayerInput1 m_Wrapper;
        public InventoryActions(@PlayerInput1 wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @PlayerInput1 m_Wrapper;
        public BuildActions(@PlayerInput1 wrapper) { m_Wrapper = wrapper; }
